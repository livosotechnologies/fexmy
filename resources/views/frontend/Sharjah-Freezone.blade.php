...
<div class="rs-about pt-10  md-pt-70 md-pb-70">
        ...
        <div class="row">
            <div class="col-lg-6  md-pl-15 m-auto">
                <div class="sec-title">
                    ...
                    <p class="pb-2">
                        FexMy Business Setup in Sharjah Free Zone is available to assist you in handling the legal paperwork, banking, visa processing and other important work.
                    </p>
    ...
    <div class="container custom pb-50">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 md-mb-50 ">
                <h2 class="text-white">
                    How to set up business in Sharjah Free Zone
                </h2>
                <p class="mt-3 text-white">
                    Business setup in Sharjah free zone is an exciting adventure, and our team is here to make it seamless and stress-free.
                </p>
                <p class="mt-3 text-white">
