    ...
    <div class="container custom pb-50">
        <div class="row">
            <div class="col-lg-6  md-pl-15 m-auto">
                <div class="sec-title">
                    <h3 class="title pb-3" style="color:#ff8202">
    ...
    <div class="card prcard p-lg-5 mb-5 mt-4" style="background-color:#ff8202">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <h3 class="text-white">
                    Benefits of Starting an Ajman Offshore Company
                </h3>
                ...
                <div class="pt-5">
                    ...
                    <ul class="listul text-white">
                        ...
                        <li>
                            <i class="fa-solid fa-check"></i>
                            Swift and Cost-Effective Registration Process
                        </li>
                        <li>
                            <i class="fa-solid fa-check"></i>
                            Efficient Registration Timeline
                        </li>
                        <li>
                            <i class="fa-solid fa-check"></i>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 m-auto">
                <img src="frontend/assets/img/service/ajmanoffshore1.jpg" class="img-fluid uaepic">
            </div>
        </div>
    </div>
</div>
...
<div class="p-lg-5" style="background-color:whitesmoke;">
    <div class="container pb-5 pt-5">
        <h2 class="pb-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 md-mb-50 ">
                    <div class="tickrow mt-3">
                        ...
                        <div>
                            <h6>Parent company's Incorporation Certificate
                            </h6>
                        </div>
                    </div>
                        ...
                        <div class="tickrow mt-3">
                            ...
                            <div>
                                <h6>Memorandum and Articles of Association
                                </h6>
                            </div>
                        </div>
                    ...
                    <div class="tickrow mt-3">
                        ...
                        <div>
                            <h6>Board Resolution affirming intent for Ajman Offshore company formation
                            </h6>
                        </div>
                    </div>
                    ...
                    <div class="tickrow mt-3">
                        ...
                        <div>
                            <h6>Certificate of Good Standing
                            </h6>
                        </div>
                    </div>
                    ...
                    <div class="tickrow mt-3">
                        ...
                        <div>
                            <h6>Passport copies of two (2) Directors
                            </h6>
                        </div>
                    </div>
                </div>
