        ...
        <div class="row">
            <div class="col-lg-6  md-pl-15 m-auto">
                <div class="sec-title">
                    ...
                    <p class="title pb-2">
                        At FexMy Business Setup, we simplify the entire process! Let us help you save time, money, and effort by providing the fastest and most secure way to set up your offshore company. </p>

                </div>
                <h6 class="title pb-2 pt-2" style="color:#ff8202">
                    Why choose FexMy?
                </h6>
                <div class="mt-3">
                    <div class="tickmark">
                        <p><i class="fa-solid fa-check"></i> Quick and reliable services
                        </p>
                    </div>
                </div>
                <div class=" mt-3">
                    <div class="tickmark">
                        <p><i class="fa-solid fa-check"></i> Strong government connections
                        </p>
                    </div>
                </div>
                <div class=" mt-3">
                    <div class="tickmark">
                        <p><i class="fa-solid fa-check"></i> International expertise
                        </p>
                    </div>
                </div>
                <div class="mt-5">
                    <h6 class="title pb-2 mt-4" style="color:#ff8202">
                    ...
                    <div class="mt-3">
                        <div class="tickmark">
                            <p><i class="fa-solid fa-check"></i> Tax benefits
                            </p>
                        </div>
                    </div>
                    <div class=" mt-3">
                        <div class="tickmark">
                            <p><i class="fa-solid fa-check"></i> 100% foreign ownership
                            </p>
                        </div>
                    </div>
                    <div class=" mt-3">
                        <div class="tickmark">
                            <p><i class="fa-solid fa-check"></i> Confidentiality
                            </p>
                        </div>
                    </div>
                </div>
                <div class=" mt-3">
                    <div class="tickmark">
                        <p><i class="fa-solid fa-check"></i> Limited liability
                        </p>
                    </div>
                </div>
