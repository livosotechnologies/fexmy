<nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
    <div class="container">
        ...
        <!-- Navigation Items -->
        <div class="collapse navbar-collapse modal-menu" id="navbarContent">
            <!-- Close button for mobile -->
            <!-- <button type="button" class="btn-close mobile-close" data-bs-toggle="collapse" data-bs-target="#navbarContent" aria-label="Close"></button> -->
...
<style>
    ...
    margin-left: 6px; /* Add space between text and icon */
    transition: transform 0.5s ease; /* Smooth rotation */
}


.nav-item:hover .dropdown-icon,
.nav-item .dropdown-menu.show + .dropdown-icon {
    transform: rotate(180deg); /* Rotate icon on hover or when dropdown is open */
}

.moicon{
    display: inline-block;
    margin-left: 6px; /* Add space between text and icon */
    transition: transform 0.5s ease; /* Smooth rotation  dropdown-item */
}

.dropdown-item:hover .moicon{
...
.dropdown-item.dropdown-toggle::after{
    ...
    @media (max-width: 991px) {
        ...
        .navbar-nav {
            ...
            align-items: center;
            box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;
            /* Adjust alignment for dropdowns */
        }
        ...
        /* Show submenu on mobile for nested dropdown */
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Add hover functionality for large screens (for nested dropdown)
