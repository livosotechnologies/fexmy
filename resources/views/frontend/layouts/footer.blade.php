                ...
                <div class="row">
                        ...
                        <div class="widget footer-widget wow fadeInUp" data-wow-delay=".6s">
                            <div class="gt-widget-about">
                                <div class="about-logo">
                                    <a href="/"><img src="{{asset('frontend/assets/img/service/footerlogo.png')}}" alt="extech"></a>
                                </div>
                                <p class="about-text"> At FexMy, we offer a comprehensive range of services tailored to meet the unique needs of our clients
                                </p>
                                <div class="gt-social style2">
                                    <a href="https://www.facebook.com/fexmyoverseas/" target="_blank"><i class="fab fa-facebook-f"></i></a>
                                  
                                    <a href="https://www.instagram.com/fexmyoverseas" target="_blank"><i class="fab fa-instagram"></i></a>
                                    <a href="https://www.linkedin.com/company/fexmy/" target="_blank"><i class="fab fa-linkedin-in"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6 col-12">
                        <div class="widget widget_nav_menu footer-widget wow fadeInUp" data-wow-delay="1s">
                            <h3 class="widget_title">Business setup</h3>
                            <div class="menu-all-pages-container">
                                <ul class="menu">
                                    <li class="footermenu-item">
                                        <a href="#" class="d-flex align-items-center" data-bs-toggle="collapse" data-bs-target="#sub-menu-1">
                                            <i class="fa-solid fa-chevrons-right"></i> Mainland Company
                                        </a>
                                        <div class="wow fadeInUp" data-wow-delay="2s">
                                            <ul id="sub-menu-1" class="collapse footersub-menu">
                                                <li> <a href="UAE-Mainland">
                                                        <i class="fa-solid fa-chevron-right"></i> UAE Mainland
                                                    </a></li>
                                                <li> <a href="Dubai-mainland">
                                                        <i class="fa-solid fa-chevron-right"></i> Dubai Mainland
                                                    </a></li>
                                                <li> <a href="Abu-Dhabi-mainland">
                                                        <i class="fa-solid fa-chevron-right"></i> AbuDhabi Mainland
                                                    </a></li>
                                                <li> <a href="Ajman-mainland">
                                                        <i class="fa-solid fa-chevron-right"></i> Ajman Mainland
                                                    </a></li>
                                                <li> <a href="Sharjah-mainland">
                                                        <i class="fa-solid fa-chevron-right"></i> Sharjah Mainland
                                                    </a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li class="footermenu-item">
                                        <a href="#" class="d-flex align-items-center" data-bs-toggle="collapse" data-bs-target="#sub-menu-2">
                                            <i class="fa-solid fa-chevrons-right"></i> Freezone Company
                                        </a>
                                        <div class="wow fadeInUp" data-wow-delay="2s">
                                            <ul id="sub-menu-2" class="collapse footersub-menu">
                                                <li> <a href="UAE-Freezone">
                                                        <i class="fa-solid fa-chevron-right"></i> UAE FreeZone
                                                    </a></li>
                                                <li> <a href="Dubai-Freezone">
                                                        <i class="fa-solid fa-chevron-right"></i> Dubai FreeZone
                                                    </a></li>
                                                <li> <a href="IFZA-Freezone">
                                                        <i class="fa-solid fa-chevron-right"></i> IFZA
                                                    </a></li>
                                                <li> <a href="Abudhabi-Freezone">
                                                        <i class="fa-solid fa-chevron-right"></i> Abudhabi Freezone
                                                    </a></li>
                                                <li> <a href="Sharjah-Freezone">
                                                        <i class="fa-solid fa-chevron-right"></i> Sharjah FreeZone
                                                    </a></li>
                                                <li> <a href="Ras-al-khaimah-Freezone">
                                                        <i class="fa-solid fa-chevron-right"></i> Ras Al khaimah
                                                    </a></li>
                                                <li> <a href="RAKEZ-Freezone">
                                                        <i class="fa-solid fa-chevron-right"></i> RAKEZ
                                                    </a></li>
                                                <li> <a href="Ajman-Freezone">
                                                        <i class="fa-solid fa-chevron-right"></i> Ajman Freezone
                                                    </a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li class="footermenu-item">
                                        <a href="#" class="d-flex align-items-center" data-bs-toggle="collapse" data-bs-target="#sub-menu-6">
                                            <i class="fa-solid fa-chevrons-right"></i> OffShore Company
                                        </a>
                                        <div class="wow fadeInUp" data-wow-delay="2s">
                                            <ul id="sub-menu-6" class="collapse footersub-menu">
                                                <li> <a href="UAE-Offshore">
                                                        <i class="fa-solid fa-chevron-right"></i> UAE Offshore
                                                    </a></li>
                                                <li> <a href="Dubai-Offshore">
                                                        <i class="fa-solid fa-chevron-right"></i> Dubai Offshore
                                                    </a></li>
                                                <li> <a href="Ajman-Offshore">
                                                        <i class="fa-solid fa-chevron-right"></i> Ajman Offshore
                                                    </a></li>
                                                <li> <a href="Jebel-ali-Offshore">
                                                        <i class="fa-solid fa-chevron-right"></i> Jebel Ali Offshore
                                                    </a></li>
                                                <li> <a href="Ras-al-khaimah-Offshore">
                                                        <i class="fa-solid fa-chevron-right"></i> Ras Al Khaimah Offshore
                                                    </a></li>

                                            </ul>
                                        </div>
                                    </li>
                                    <li><a href="office-space"><i class="fa-solid fa-chevrons-right"></i>Office Space</a>
                                    </li>
                                    <li><a href="sponsership"><i class="fa-solid fa-chevrons-right"></i>Sponsership</a>
                                    </li>
                    ...
                    <div class="col-xl-3 col-md-6 col-12">
                        <div class="widget widget_nav_menu footer-widget wow fadeInUp" data-wow-delay="1s">
                            ...
                            <div class="menu-all-pages-container">
                                <ul class="menu">
                                    <li class="footermenu-item">
                                        <a href="#" class="d-flex align-items-center" data-bs-toggle="collapse" data-bs-target="#sub-menu-3">
                                            <i class="fa-solid fa-chevrons-right"></i> License
                                        </a>
                                        <div class="wow fadeInUp" data-wow-delay="3s">
                                            <ul id="sub-menu-3" class="collapse footersub-menu">
                                                <li> <a href="Business-Licenses">
                                                        <i class="fa-solid fa-chevron-right"></i> Business Licenses
                                                    </a></li>
                                                <li> <a href="Commercial-trade-license">
                                                        <i class="fa-solid fa-chevron-right"></i> Commercial Trade License
                                                    </a></li>
                                                <li> <a href="Abu-Dhabi-mainland">
                                                        <i class="fa-solid fa-chevron-right"></i> Industrial License
                                                    </a></li>
                                                <li> <a href="Ajman-mainland">
                                                        <i class="fa-solid fa-chevron-right"></i> professional Trade License
                                                    </a></li>
                                    ...
                                    <li class="footermenu-item">
                                        <a href="#" class="d-flex align-items-center" data-bs-toggle="collapse" data-bs-target="#sub-menu-4">
                                            <i class="fa-solid fa-chevrons-right"></i> Pro Services
                                        </a>
                                        <div class="wow fadeInUp" data-wow-delay="2s">
                                            <ul id="sub-menu-4" class="collapse footersub-menu">
                                                <li> <a href="pro-services-dubai">
                                                        <i class="fa-solid fa-chevron-right"></i> Pro Services Dubai
                                                    </a></li>
                                                <li> <a href="pro-services–sharjah">
                                                        <i class="fa-solid fa-chevron-right"></i> Pro Services Sharjah
                                                    </a></li>
                                                <li> <a href="pro-services-ajman">
                                                        <i class="fa-solid fa-chevron-right"></i> Pro Services Ajman
                                                    </a></li>
                                                <li> <a href="golden-visa">
                                                        <i class="fa-solid fa-chevron-right"></i> Golden Visa
                                                    </a></li>
                                    ...
                                    <li class="footermenu-item">
                                        <a href="#" class="d-flex align-items-center" data-bs-toggle="collapse" data-bs-target="#sub-menu-5">
                                            <i class="fa-solid fa-chevrons-right"></i> Other Services
                                        </a>
                                        <div class="wow fadeInUp" data-wow-delay="2s">
                                            <ul id="sub-menu-5" class="collapse footersub-menu">
                                                <li> <a href="bank-account-opening-dubai">
                                                        <i class="fa-solid fa-chevron-right"></i> Bank Account Opening
                                                    </a></li>
                                                <li> <a href="Dubai-Offshore">
                                                        <i class="fa-solid fa-chevron-right"></i> VAT Registration
                                                    </a></li>
                                                <li> <a href="trademark-registration">
                                                        <i class="fa-solid fa-chevron-right"></i> Trademark Registration
                                                    </a></li>
                                                <li> <a href="local-sponsorship">
                                                        <i class="fa-solid fa-chevron-right"></i> Local Sponsorship
                                                    </a></li>
                                                <li> <a href="Bank-Gurantee">
                                                        <i class="fa-solid fa-chevron-right"></i> Bank Gurantee
                                                    </a></li>
                                                <li> <a href="auditing-services-dubai">
                                                        <i class="fa-solid fa-chevron-right"></i> Auditing Services
                                                    </a></li>
                        ...
                        <div class="widget widget_nav_menu footer-widget wow fadeInUp" data-wow-delay="1.6s">
                            ...
                            <div class="checklist style2">
                                <ul class="ps-0">
                                    ...
                                    <li class="text-white">info@Fexmy.co</li>
                                </ul>
                                <ul class="ps-0">
                                    <li class="text-white"><i class="fa-solid fa-phone"></i></li>
                                    <li class="text-white">(+971) 58-513-8971</li>
                                </ul>
    ...
    <div class="copyright-wrap bg-theme">
        <div class="text-center">
            <p class="copyright text-white">
                <i class="fal fa-copyright"></i> All Copyright 2025 by FexMy
            </p>
        </div>
    </div>
</footer>