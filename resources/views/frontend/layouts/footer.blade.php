                            ...
                            <div class="widget footer-widget wow fadeInUp" data-wow-delay=".6s">
                                <div class="gt-widget-about">
                                    <div class="about-logo">
                                        <a href="index-2.html"><img src="{{asset('frontend/assets/img/footer-logo.svg')}}" alt="extech"></a>
                                    </div>
                                    <p class="about-text"> At Lealava Technology, we offer a comprehensive range of services tailored to meet the unique needs of our clients
                                    </p>
                        ...
                        <div class="col-xl-2 col-md-6 col-12">
                            <div class="widget widget_nav_menu footer-widget wow fadeInUp" data-wow-delay="1s">
                                ...
                                <div class="menu-all-pages-container">
                                    <ul class="menu">
                                    <li><a href="/"><i class="fa-solid fa-chevrons-right"></i>Home</a>
                                    </li>
                                        <li><a href="/about"><i class="fa-solid fa-chevrons-right"></i>Lealava
                                                About</a>
                                        </li>
                                        <li><a href="/services"><i class="fa-solid fa-chevrons-right"></i>Our
                                                Services</a>
                                        </li>
                                        <li><a href="/blogs"><i class="fa-solid fa-chevrons-right"></i>Our
                                                Blogs</a>
                                        </li>
                            ...
                            <div class="widget widget_nav_menu footer-widget wow fadeInUp" data-wow-delay="1s">
                                ...
                                <div class="menu-all-pages-container">
                                    <ul class="menu">
                                        ...
                                        <li><a href="/services"><i class="fa-solid fa-chevrons-right"></i>Price</a>
                                        </li>
                                        <li><a href="/portfolios"><i class="fa-solid fa-chevrons-right"></i>Portfolio</a></li>
                                        <li><a href="/contacts"><i class="fa-solid fa-chevrons-right"></i>Contact
                                                Us</a>
                                        </li>
            ...
            <div class="container">
                <div class="copyright-layout">
                    <div class="layout-text wow fadeInUp" data-wow-delay=".3s">
                        <p class="copyright">
                            <i class="fal fa-copyright"></i> All Copyright 2024 by <a href="index-2.html">Lealava Technology</a>
                        </p>
                    </div>
