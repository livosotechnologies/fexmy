...
<div class="p-lg-5 mt-4" style="background-color:whitesmoke;">
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <h6 class="mt-3">
                Opening a bank account in Dubai in 2023 is surprisingly easy, however criteria differ by bank. Consider that our Experts will advise and inform. The key steps for opening a Dubai business bank account are:
            </h6>
            <div class="pt-5">
                ...
                <div class="tickrow mt-3">
                    ...
                    <div>
                        <p>
                            <b>Complete the required documentation and complete the bank application form.</b>
                        </p>
                    </div>
                </div>
                <div class="tickrow mt-3">
                    ...
                    <div>
                        <p>
                            <b>Fill out the application carefully.</b>
                        </p>
                    </div>
                </div>
                <div class="tickrow mt-3">
                    ...
                    <div>
                        <p>
                            <b>
                                Fill out the form to open a bank account in UAE.</b>
                        </p>
                    </div>
                </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 m-auto">
            <img src="frontend/assets/img/service/bank.webp" class="img-fluid uaepic">
        </div>
    </div>
    <div class="pt-5">
        <p>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 md-mb-50 ">
                <div class="card p-4 mb-4">
                    <div class="images-part noimg mb-2">
                        <img src="frontend/assets/img/service/no1.webp" alt="Images">
                    </div>
                    <div>
                ...
                <div class="mb-4">
                    <img src="frontend/assets/img/service/dubai1.jpg" alt="Images">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12  md-pl-15 m-auto">
            <div class="mb-4">
                    <img src="frontend/assets/img/service/dubai2.webp" alt="Images">
                </div>
