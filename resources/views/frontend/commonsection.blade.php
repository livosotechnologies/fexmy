...
<section class="tesimonial-section-3 section-padding section-bg-2 bg-cover">
            ...
            <div class="section-title title-area  mx-auto ">
                ...
                <div class="container">
                    ...
                    <div class="row">
                                    ...
                                    <div class="flip-card-back pb-5">
                                        ...
                                        <div class="pricing-table-price">
                                            <div class="pricing-table-bags">
                                                <span class="pricing-currency">GBP</span>
                                        ...
                                        <div class="pricing-table-body">
                                            <ul class="listing-style">
                                                ...
                                                <li>
                                                    <i class="fa fa-check-circle"></i>
                                                    <span>VAT consultation & registration</span>
                                                </li>
                                                <li>
                                                    <i class="fa fa-check-circle"></i>
                            ...
                            <div class="flip-card">
                                ...
                                <div class="flip-card-inner">
                                    ...
                                    <div class="flip-card-back pb-5">
                                        ...
                                        <div class="pricing-table-price">
                                            <div class="pricing-table-bags">
                                            <span class="pricing-currency">AED</span>
                                            <span class="table-price-text">10,999</span>
                                            </div>
                                            <p>100% business ownership</p>
                                        </div>
                                        <div class="pricing-table-body">
                            ...
                            <div class="flip-card">
                                ...
                                <div class="flip-card-inner">
                                    ...
                                    <div class="flip-card-back pb-5">
                                        ...
                                        <div class="pricing-table-price">
                                            <div class="pricing-table-bags">
                                            <span class="pricing-currency">SGD</span>
                                            <span class="table-price-text">2,500</span>
                                            </div>
                                            <p>100% business ownership</p>
                                        </div>
                                        <div class="pricing-table-body">
                                        ...
                                        <li>
                                            <i class="fa fa-check-circle"></i>
                                            <span>Physical presence not required </span>
                                        </li>
                                        <li>
                                            <i class="fa fa-check-circle"></i>
                        ...
                        <!-- Add other cards as needed (you can repeat the structure for more cards) -->
    ...
    <section class="project-section-3 section-padding pb-0 fix bg-cover"
        style="background-image: url('frontend/assets/img/testimonial/bg.jpg');">
        <div class="container">
