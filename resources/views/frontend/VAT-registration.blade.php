    ...
    <div class="container">
        <div class="col-lg-6">
            <div class="page-heading">
                ...
                VAT or Value-added Tax is a form of indirect tax adopted and practised in 160 world countries. To be more precise, VAT is a taxation system imposed on the consumption of various commodities, products or services.                </h6>
    ...
    <div class="card prcard p-lg-5 mb-5 mt-4" style="background-color:#ff8202">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <h4 class="text-white">
                    What Benefits bank-account-opening
                     Provide in Dubai?
                </h4>
                <div class="pt-5">
