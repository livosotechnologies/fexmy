        ...
        <div class="row">
            <div class="col-lg-6  md-pl-15 m-auto">
                <div class="sec-title">
                    ...
                    <p class="pb-2">
                        A Business Trade License is a must-have document to operate legally in Dubai. The process of
...
<div class="rs-about pt-100  md-pt-70 md-pb-70" style="background-color:#ff8202;">
 ...
 <div class="container py-5">
        ...
        <div class="row mb-5">
            <div class="col-12">
                <h3 class="custom-heading-license">How To Renew Your Dubai Commercial Trade License</h3>
                <div class="row g-4">
                    <div class="col-md-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 m-auto">
                ...
                <p class="mt-4">
                    ...
                    within UAE or even outside the country, a commercial business trade license is a must. Some of the
