        ...
        <div class="row">
            <div class="col-lg-6  md-pl-15 m-auto">
                <div class="sec-title">
                    ...
                    <p class="pb-2">
                    FexMy Business Setup’s offshore business setup Dubai packages offer quick, safe and hassle-free solutions. We help you register your company, get a company incorporation certificate, offshore bank accounts and everything else that you would require to set up your offshore company.
                    </p>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12  md-pl-15 m-auto scrollable-col">
                <div class="row mt-3">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 ">
                        ...
                        <h6 class="text-white">Consultation and Planning                         
                        </h6>
                        <p class="mt-3 text-white">
