...
<div class="breadcrumb-wrapper bg-cover" style="background-image: url('frontend/assets/img/breadcrumb.jpg');">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mt-4 mt-lg-0">
                        <div class="about-content">
                            ...
                            Lealava Technology is a forward-thinking IT solutions provider dedicated to transforming businesses through innovative technology.
                            </p>
                            <p class="mt-3 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
    ...
    <!-- <section class="project-section-2 section-padding fix">
        <div class="left-shape">
            <img src="{{asset('frontend/assets/img/project/left-shape.png')}}" alt="shape-img">
        </div>
        <div class="right-shape">
            <img src="{{asset('frontend/assets/img/project/right-shape.png')}}" alt="shape-img">
        </div>
        <div class="container">
            <div class="row d-flex align-items-center justify-content-between">
                <div class="col-xl-6">
                    <div class="section-title mb-3 mxw-650">
                        <div class="subtitle"> <img src="{{asset('frontend/assets/img/icon/arrowLeft.svg')}}" alt="icon"> <span> PROJECTS
                            </span><img src="{asset{('frontend/assets/img/icon/arrowRight.svg')}}" alt="icon"></div>
                        <h2 class="title"> Our Latest Incredible <br> Client's Projects </h2>
                    </div>
                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="project-items style-2">
                                <div class="project-image">
                                    <img src="{{asset('frontend/assets/img/project/05.jpg')}}" alt="project-img">
                ...
                <div class="marquee-inner to-left">
                    <ul class="marqee-list d-flex">
                        <li class="marquee-item style-2">
                            <span class="text-slider"><img src="{{asset('frontend/assets/img/asterisk.svg')}}" alt="img"></span><span
